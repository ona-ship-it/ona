...
function GoogleSignIn() {
    ...
    const handleSignIn = async ()=>{
        try {
            ...
            const callbackUrl = "".concat(window.location.origin, "/auth/callback?redirectTo=").concat(encodeURIComponent(redirectPath));
...
function LoginPage() {
    ...
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$temp$2d$restore$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
...
_s(LoginPage, "rAlklbxfX8dDNzkAzrl7fEgRhys=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$temp$2d$restore$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
