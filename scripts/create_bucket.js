...
// Usage: node scripts/create_bucket.js [bucketName]
...
if (enableAvif) allowedMimeTypes.push('image/avif');
...
async function ensureBucket() {
  try {
    ...
    if (!existing) {
      ...
      console.log('Bucket already exists. Ensuring public and mime types...');
