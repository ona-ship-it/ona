...
Note: This file is intentionally commented out to prevent the CLI from
executing read-only inspection queries during automated migration runs.
*/
...
-- SELECT id, username, onagui_type, created_at
