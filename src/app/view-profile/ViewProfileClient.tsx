      ...
      try {
        ...
        if (!cancelled) {
          ...
          for (const k of avatarKeys) {
            const v = meta[k];
            if (typeof v === 'string' && v.trim().length > 0) { found = v; break; }
          }
          setAvatarUrl(found);
          setLoading(false);
        }
          ...
          <div className="md:col-span-1 bg-gray-800 rounded-lg border border-gray-700 p-6">
            <div className="flex items-center gap-4 mb-4">
              {avatarUrl && !avatarFailed ? (
                ...
                <div className="w-16 h-16 rounded-full bg-gray-700 flex items-center justify-center text-gray-200 font-semibold text-xl">
