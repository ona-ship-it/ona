...
export default function GiveawaysClient() {
  ...
  const handleGiveawaySubmit = (formData) => {
    console.log('Giveaway form submitted:', formData);
    // Here you would typically send the data to your backend
    setShowGiveawayForm(false);
    // You could also update the UI to show the new giveaway
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-purple-500/30 flex items-center"
          >
            + create my Giveaway
          </button>
        </div>
        ...
        {showGiveawayForm && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-900 rounded-xl w-full max-w-2xl">
              <GiveawayForm onSubmit={handleGiveawaySubmit} onCancel={() => setShowGiveawayForm(false)} />
            </div>
          </div>
        )}
