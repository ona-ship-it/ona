          ...
          <div
            ...
            className={`${
              isDarker
                ...
                : 'bg-white'
            } rounded-xl shadow-lg border-l-4 border-${item.color}-500 overflow-hidden hover:shadow-xl transition-all duration-300 ring-1 ring-${item.color}-500/20 hover:ring-${item.color}-500/40`}
          >
            {/* Photo space */}
            <div className={`h-48 w-full ${isDarker ? 'bg-gray-800' : 'bg-gray-100'} flex items-center justify-center overflow-hidden`}>
              <div className={`w-full h-full bg-gradient-to-r from-${item.color}-500/20 to-${item.color}-700/30 flex items-center justify-center`}>
