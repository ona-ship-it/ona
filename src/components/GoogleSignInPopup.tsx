...
const GoogleSignInPopup: React.FC<GoogleSignInPopupProps> = ({ onClose, onSignIn }) => {
  // This would come from Google Auth in a real implementation
  // Using empty values as placeholders until real auth is implemented
  const userData = {
    name: '',
    email: '',
    profilePicture: ''
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none flex justify-end">
      <div className="bg-black/80 backdrop-blur-sm rounded-lg shadow-xl w-80 overflow-hidden mt-4 mr-4 pointer-events-auto border border-gray-700">
