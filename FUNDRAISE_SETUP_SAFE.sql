-- ============================================
-- ONAGUI FUNDRAISE SYSTEM - SAFE SQL SETUP
-- This version won't fail if objects already exist
-- ============================================

-- Drop existing policies to recreate them
DROP POLICY IF EXISTS "Anyone can view active fundraisers" ON onagui.fundraisers;
DROP POLICY IF EXISTS "Users can create fundraisers" ON onagui.fundraisers;
DROP POLICY IF EXISTS "Users can update own fundraisers" ON onagui.fundraisers;
DROP POLICY IF EXISTS "Anyone can view donations" ON onagui.donations;
DROP POLICY IF EXISTS "Anyone can create donations" ON onagui.donations;
DROP POLICY IF EXISTS "Anyone can view updates" ON onagui.fundraiser_updates;
DROP POLICY IF EXISTS "Owners can create updates" ON onagui.fundraiser_updates;
DROP POLICY IF EXISTS "Anyone can view comments" ON onagui.fundraiser_comments;
DROP POLICY IF EXISTS "Authenticated users can comment" ON onagui.fundraiser_comments;
...
DROP INDEX IF EXISTS onagui.idx_fundraisers_user_id;
DROP INDEX IF EXISTS onagui.idx_fundraisers_status;
DROP INDEX IF EXISTS onagui.idx_fundraisers_category;
DROP INDEX IF EXISTS onagui.idx_fundraisers_created_at;
DROP INDEX IF EXISTS onagui.idx_donations_fundraiser_id;
DROP INDEX IF EXISTS onagui.idx_donations_user_id;
DROP INDEX IF EXISTS onagui.idx_donations_status;
DROP INDEX IF EXISTS onagui.idx_fundraiser_updates_fundraiser_id;
DROP INDEX IF EXISTS onagui.idx_fundraiser_comments_fundraiser_id;
...
-- Fundraisers Policies (recreated)
...
-- Function: Update fundraiser raised amount
...
-- ============================================
-- SETUP COMPLETE!
-- Your fundraise system is now ready to use.
-- ============================================
